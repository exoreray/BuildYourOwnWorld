...
public class MainMenu {
    ...
    public MainMenu() {
        try {
            lionKing25 = Font.createFont(Font.TRUETYPE_FONT, new File("byow/Core/CustomFonts/lion_king.ttf"))
                    .deriveFont(Font.BOLD, 25);
            GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
            ge.registerFont(lionKing25);
            lionKing35 = Font.createFont(Font.TRUETYPE_FONT, new File("byow/Core/CustomFonts/lion_king.ttf"))
        ...
        neonYellow = new Color(242, 242, 62);
